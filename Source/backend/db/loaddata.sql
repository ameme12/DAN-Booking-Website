...
VALUES
    ('alice@mcgill.ca', 'password1', 1),
    ('bob@mcgill.ca', 'password2', 2),
    ('charlie@mcgill.ca', 'password3', 3),
    ('diana@mail.mcgill.ca', 'password4', 4),
    ('ethan@mail.mcgill.ca', 'password5', 5),
    ('fiona@mail.mcgill.ca', 'password6', 6),
    ('george@mail.mcgill.ca', 'password7', 7),
    ('hannah@mail.mcgill.ca', 'password8', 8),
    ('ian@mail.mcgill.ca', 'password9', 9),
    ('jack@mail.mcgill.ca', 'password10', 10),
    ('karen@mail.mcgill.ca', 'password11', 11),
    ('leo@mail.mcgill.ca', 'password12', 12),
    ('martha@mail.mcgill.ca', 'password13', 13),
    ('nathan@mail.mcgill.ca', 'password14', 14),
    ('olivia@mail.mcgill.ca', 'password15', 15),
    ('paul@mail.mcgill.ca', 'password16', 16),
    ('quincy@mail.mcgill.ca', 'password17', 17),
    ('rachel@mail.mcgill.ca', 'password18', 18),
    ('steve@mail.mcgill.ca', 'password19', 19),
    ('tony@mail.mcgill.ca', 'password20', 20),
    ('uma@mail.mcgill.ca', 'password21', 21),
    ('victor@mail.mcgill.ca', 'password22', 22),
    ('will@mail.mcgill.ca', 'password23', 23),
    ('xander@mail.mcgill.ca', 'password24', 24),
    ('yasmine@mail.mcgill.ca', 'password25', 25),
    ('zack@mail.mcgill.ca', 'password26', 26),
    ('liam@mail.mcgill.ca', 'password27', 27),
    ('emma@mail.mcgill.ca', 'password28', 28),
    ('chris@mail.mcgill.ca', 'password29', 29),
    ('scarlett@mail.mcgill.ca', 'password30', 30);
